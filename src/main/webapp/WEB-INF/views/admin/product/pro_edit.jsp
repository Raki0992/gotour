                    ...
                    <div class="col-md-3">
                      <select class="form-control" id="firstCategory">
                        ...
                        <c:forEach items="${firstCategoryList }" var="categoryVO">
                        	<option value="${categoryVO.cg_code }" ${categoryVO.cg_name == first_category.cg_parent_code? 'selected':'' }>${categoryVO.cg_name }</option>
                        </c:forEach>
                      </select>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <select class="form-control" id="pro_buy" name="pro_buy">
                        <option value="Y" value="${ProductVO.pro_buy == 'Y'? 'selected':'' }">판매가능</option>
                        <option value="N" value="${ProductVO.pro_buy == 'N'? 'selected':'' }">판매불가능</option>
                      </select>
                    </div>
                  </div>

      ...
      <form role="form" id="confirmPwForm" method="post" action="/member/delete">
        <div class="box-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="text" class="form-control" name="mbsp_id" id="mbsp_id" placeholder="아이디">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="password" class="form-control" name="mbsp_password" id="mbsp_password" placeholder="비밀번호">
            </div>
          </div>
